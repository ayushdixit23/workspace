          ...
          <div className="flex justify-center items-center gap-1">
            ...
            >
              <div className="flex justify-between items-center relative p-1.5 cursor-pointer h-full gap-2 px-2 w-full text-sm">
                <div className="flex items-center gap-2">{dateValue} Days</div>
          ...
          {analyticsdata?.commerged
            ...
            .map((w) =>
              w?.topic.map((d, i) => (
                <div
                  key={i}
                  className="bg-[#fafafa] dark:text-white dark:bg-[#323b4e] p-1 px-4 rounded-2xl"
                >
                  {d?.title}
                </div>
              ))
