				...
				checkstore?.exist && checkstore?.isverified === false ?
					...
					<div className="h-full w-full rounded-xl ">
						<div className="flex flex-col justify-center items-center h-full">
							<div className="text-2xl font-semibold dark:text-white">Verification Process Underway</div>
							<Image src={verify} alt="image" className="max-w-[250px]" />
							<div className="text-sm">Status : In review</div>
							<div className="flex flex-col text-center max-w-[85%] text-sm leading-snug sm:max-w-[50%] pt-9 justify-center items-center">We appreciate your patience as we work to verify your account. It Normally takes upto 24 hours.
