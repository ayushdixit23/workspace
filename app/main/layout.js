  ...
  return (
    <div>
      <div className="bg-[#f1f1f1]  vs:max-sm:h-[95.5vh] font-nunito duration-75 min-h-screen w-screen flex overflow-auto scrollbar-hide">
        <div className={`${path === "/main/community/editCommunity" || path === "/main/community/createCommunity" || path === "/main/store/addproduct" || path === "/main/store/editproduct" || isLoading ? "pn:max-sm:hidden" : null} h-full z-20`}>
          <MemorizedNav />
        </div>
