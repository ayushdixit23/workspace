...
const page = () => {
  ...
  const { data: datawithdraw, refetch: refetchwithdraw } =
    useFetchWithDrawRequestQuery({ id }, { skip: !id });
  ...
  const maskAccountNumber = (accountNumber) => {
    ...
    if (length <= 4) {
      // If the account number is 4 digits or fewer, return it as is
      return accountNumber;
    }
    const lastFourDigits = accountNumber.slice(-4);
    const masked = "*".repeat(length - 4) + lastFourDigits;
    return masked;
  };
                    ...
                    {bank.verified === "pending" ? (
                      ...
                      >
                        <div className="flex justify-center w-full gap-4 items-center">
                          ...
                          <div className="sm:text-sm font-semibold w-full">
                            {bank.verified == "approved" ? (
                              <div className="flex justify-between items-center gap-2 w-full ">
                                <div>Bank Add Successfully !</div>
                                {
                                  <div
                                    onClick={(e) => {
                                      e.stopPropagation();
                                    ...
                                    className="p-1 px-3 cursor-pointer bg-[#374047] text-xs text-white rounded-2xl"
                                  >
                                    Withdraw
                                  </div>
                                }
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 my-3 ">
                            ...
                            <>
                              <div className="bg-[#f1f1f1] rounded-lg dark:bg-[#3d4654]">
                                <div className="flex flex-col py-2 text-[14px] font-semibold gap-1 justify-center items-center">
                                  ...
                                  <div>
                                    ₹
                                    {data?.earningStats?.storeearning.toFixed(
                                      2
                                    )}
                                  </div>
                                </div>
                    ...
                    <div className="flex flex-col gap-3 bg-white sm:max-h-[310px] dark:bg-[#273142] dark:border-[#3d4654] dark:border shadow-sm py-4 px-3 rounded-xl sm:max-w-[450px]">
                      ...
                      {(state1.members < 150 || state1.engagementrate < 10) && (
                        <div className="text-sm">
                          Need more topics and power to earn? Reach 150+ members
                          and maintain a 10% engagement rate!
                        </div>
                      )}
                      {state1.members > 150 &&
                              ...
                              <>
                                <div className="bg-[#f1f1f1] rounded-lg dark:bg-[#3d4654]">
                                  <div className="flex flex-col py-2 text-[14px] font-semibold gap-1 justify-center items-center">
                                    <div>Total Earnings</div>
                                    <div>
                                      ₹{Number(state1.earnings).toFixed(2)}
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div className="flex flex-col gap-3 bg-white dark:bg-[#273142] dark:border-[#3d4654] dark:border shadow-sm py-4 px-3 rounded-xl sm:max-w-[450px]">
                      ...
                      {(state2.members < 500 ||
                        ...
                        state2.status !== "approved" && (
                          <div className="text-sm">
                            Make money with ads on your posts! Earn from ads
                            before, during, and after your content.
                          </div>
                        )}
        ...
        <>
          ...
          >
            <div className="flex justify-center shadow-md items-center w-[90%] pp:w-[65%] sm:max-w-[500px] lg:w-[30%] p-3 rounded-xl dark:bg-[#273142] bg-white">
              <div className="flex flex-col mt-2 p-1 gap-3">
                <div className="flex justify-between items-center">
                  <div className="text-xl px-2 font-semibold">Withdraw</div>
                  <div
                ...
                <div className="text-center pb-1 text-[26px] font-semibold">
                  ₹ {data?.earningStats?.pendingpayments}
                </div>
                <div className="flex flex-col gap-1 px-3 border rounded-xl py-2">
                  <div>Branchname: {bank.branchname}</div>
                  <div>Account No: {maskAccountNumber(bank.accountno)}</div>
                </div>
                ...
                <div
                  ...
                  className="p-2 px-4 text-center text-sm rounded-xl bg-[#4880FF] cursor-pointer text-white"
                >
                  Request Withdraw
                </div>
              </div>
          ...
          <div className="flex  flex-col gap-2 ">
            <div
              ...
              className="flex items-center cursor-pointer gap-1 px-2 underline  text-sm"
            >
              <MdOutlineArrowBackIosNew />
              <div>Back</div>
            </div>
            <div className="w-full mt-3">
              <div className="grid grid-cols-2 w-full gap-7">
                <div className="bg-white rounded-xl flex flex-col gap-1 p-3 dark:bg-[#273142]">
                ...
                <div className="bg-white rounded-xl flex justify-between items-center w-full gap-1 p-3 dark:bg-[#273142]">
                  ...
                  <div
                    ...
                    className="p-1 px-4 text-sm border dark:border-white border-black rounded-xl"
                  >
                    WithDraw
                  </div>
                </div>
              ...
              <div className="p-4 dark:bg-[#273142] dark:text-white rounded-xl mt-4 text-2xl font-semibold bg-white">
                Transaction history
              </div>
              <div class="relative overflow-x-auto mt-4 shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right dark:bg-[#273142]">
