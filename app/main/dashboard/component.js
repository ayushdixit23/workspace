...
function Dashboard() {
	...
	const data = analyticsdata?.prositeData?.visitors && analyticsdata?.prositeData?.visitors?.map((d) => ({
		visitors: d?.visitors,
	...
	return (
		<div className="flex flex-col w-full sm:h-full">
			...
			<div className="sm:h-[90%] mb-2">
				...
				{/* prosite */}
				{change === "prosite" && (
					<div className="grid mt-2 grid-cols-1 w-full pn:max-sm:px-3">
						<div className="grid sm:grid-cols-3 grid-cols-2 gap-4 sm:gap-6 w-full">
							...
							<div className="bg-white rounded-xl flex justify-between items-center w-full gap-1 p-3 dark:bg-[#273142]">
								<div className="flex flex-col gap-1">
									<div className="flex items-center gap-2">
										<div className="w-2 h-2 rounded-full bg-[#7C41FF]"></div>
										<div className="text-sm">Clicks</div>
									</div>
									<div className="text-xl font-semibold">N/A</div>
								</div>
							</div>{" "}
							<div className="bg-white pn:max-sm:col-span-2 w-full rounded-xl flex flex-col gap-1 p-3 dark:bg-[#273142]">
								<div className="flex items-center gap-2">
						...
						<div className="grid sm:grid-cols-3 mt-4 gap-4 sm:gap-6 w-full">
							<div className="sm:col-span-2 flex flex-col bg-white dark:bg-[#273142] py-2 rounded-xl">
								<div className="text-sm font-semibold p-2 px-4">Analytics</div>
								{/* <div className="flex text-sm font-semibold px-4 items-center">
									<div>Lifetime:</div>
								...
								<div className="w-full p-2 h-full flex justify-center items-center z-0">
									<ResponsiveContainer style={{ fontSize: "12px" }} width="100%" height={360}  >
										<LineChart data={data}
							...
							<div className="bg-white dark:bg-[#273142] p-2 w-full rounded-xl">
											...
											<div className='flex justify-between items-center relative p-1.5 cursor-pointer h-full gap-2 px-2 w-full text-sm'>
												...
												<div className={`${toggle ? "top-[45px]" : "top-0 border-none hidden text-[0px] w-[0px] h-[0px]"} absolute left-0 bg-[#f7f7f7] duration-100 dark:bg-[#323d4e] rounded-xl z-50 w-full`}>
													<div className='flex flex-col gap-3 px-2 py-1 max-h-[300px] overflow-y-scroll no-scrollbar'>
														...
														<div onClick={() => setType("Location")}>Location</div>
													</div>
												</div>
											</div>
										</div >
										...
										{analyticsdata?.prositeData?.location.length > 0 ? (
											<div className="dark:text-white text-sm">
												...
												<div className="flex justify-between mt-3 px-1 items-center">
													<div className="text-sm font-semibold pb-1">Top Location</div>
												</div>
												<div className="my-3 flex flex-col gap-4">
													{analyticsdata?.prositeData?.location &&
														analyticsdata?.prositeData?.location?.map((d, i) => (
