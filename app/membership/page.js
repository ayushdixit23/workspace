		...
		<div className="bg-gray-300 min-h-[100vh] scrollbar-hide flex items-center justify-center">
			<div className="mx-5 pb-10">
              ...
              `}
				...
				<div className="sm:max-w-[1200px] max-w-[450px] mx-auto bg-white rounded-xl">
					<table className="w-full text-start border-spacing-5 border-separate flex gap-4 flex-col sm:flex-row p-5 lg:p-0">
