    ...
    <div className="w-full h-full">
      {memberships === "Free" ? (
        <div className="w-full pn:max-sm:h-[240px] sm:h-full ">
          <Prem
            height="h-full"
            buttontext={"Unlock Locations"}
            text={
              "Discover where your community members are based to plan local events, target specific regions, and enhance your outreach efforts."
            }
            bgimage={"bg-locationlight dark:bg-locationdark"}
          />
        </div>
      ) : (
        <div className="w-full h-full">
