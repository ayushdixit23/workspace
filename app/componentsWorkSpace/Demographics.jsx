      ...
      <div className="w-full sm:h-full">
        {memberships === "Free" ? (
          <div className="w-full pn:max-sm:h-[240px] sm:h-full">
            ...
            <Prem
              height="h-full"
              buttontext={"Unlock Demographics"}
              text={
                "Know your community’s members age, gender, and interests to tailor your content perfectly! "
              }
          ...
          <div className="w-full sm:h-full">
            {data > 0 ? (
              <div className="p-3 border text-sm dark:border-[#3d4654] dark:text-white rounded-xl">
